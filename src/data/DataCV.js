export const [name, dedication] = [
  "José Tomás Molina López",
...
export const [profileDescription] = [
  "Hardworking. Able to effectively self-manage during independent projects, as well as collaborate as part of a productive team. I found a great love for computers as a child when I saw my grandfather in his 60s in a Microsoft Office course for its great utility. Seeing as still his age, he tried to adapt to technology to see how to simplify his tasks by performing them in a simpler and more efficient way",
];
...
export const [birthDate, birthPlace] = [
  "27 of February, 1996",
  "La Vega, Dominican Republic",
];
export const [codingData, frameData, passiveData] = [
...
export const detailsData = "Musician - Signer, gamer, and Basketball Lover.";
export const educationalData = [
  ...
  },
  {
    ...
    initialDate: "2021",
    finalDate: "2021",
    degree: "Web Programming Foundations",
    tasks: [],
  },
  {
    organization: "LinkedIn Learning - License & Certifications",
    initialDate: "2021",
    finalDate: "2021",
    degree: "Succeeding in Web Development: Full Stack and Frond End",
    tasks: [],
  },
];
